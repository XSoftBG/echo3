...
public class UserInstance implements Serializable {
     ...
     * The container.
     */
    private final UserInstanceContainer container;
     ...
     */
    private final Map componentToRenderStateMap = new HashMap();
    
    /**
     * <code>PropertyChangeListener</code> for supported <code>ApplicationInstance</code>.
     */
    private final PropertyChangeListener applicationPropertyChangeListener = new SerializablePropertyChangeListener() {
        /**
   ...
   /**
    ...
    public void dispose() {
        if (applicationInstance != null) {
            ApplicationInstance activeAppInstance = ApplicationInstance.getActive();
            try {                
                ApplicationInstance.setActive(applicationInstance);
                applicationInstance.dispose();
                if (applicationWebSocket != null) applicationWebSocket.dispose();
                applicationInstance.removePropertyChangeListener(applicationPropertyChangeListener);
            } finally {
                ApplicationInstance.setActive(activeAppInstance);
            }
        }
    }
